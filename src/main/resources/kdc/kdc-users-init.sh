...
rm -f /var/lib/secret/broker1.key 2>&1 > /dev/null
rm -f /var/lib/secret/broker2.key 2>&1 > /dev/null
rm -f /var/lib/secret/broker3.key 2>&1 > /dev/null
...
chmod a+r /var/lib/secret/broker1.key
chmod a+r /var/lib/secret/broker2.key
chmod a+r /var/lib/secret/broker3.key
